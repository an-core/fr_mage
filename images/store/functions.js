    ...
    `;
      ...
      const GITHUB_BASE_URL = 'https://an-core.github.io/f-mage/images';
      ...
      document.addEventListener('click', function(e) {
          const contactsItem = document.querySelector('.contacts-item');
          if (contactsItem && !contactsItem.contains(e.target))
              contactsActions.classList.remove('visible');
      });
